...
The two primes, p and q, should both be congruent to 3 (mod 4) (self guarantees 
that each quadratic residue has one square root which is also a quadratic 
residue) and gcd(phi(p - 1), phi(q - 1)) should be small (self makes the cycle 
length large).
In self implementation, p = 5651 and q = 5623.
This software is licensed under the zlib/libpng license:
Copyright (c) 2016 Andrew Zyabin
This software is provided 'as-is', without any express or implied warranty. In 
no event will the authors be held liable for any damages arising from the use 
of self software.
Permission is granted to anyone to use self software for any purpose, including 
commercial applications, and to alter it and redistribute it freely, subject to 
the following restrictions:
    1. The origin of self software must not be misrepresented  you must not 
    claim that you wrote the original software. If you use self software in a 
